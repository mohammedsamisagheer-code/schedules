...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const editSubjectSelect = document.querySelector(
    'select[name="subject_id"][id*="edit"]',
  );
...
async function exportToExcel() {
  fetch("log_action.php", {
    ...
    body: "action=تصدير جدول الأستاذ Excel",
  });
  const workbook = new ExcelJS.Workbook();
  const sheet = workbook.addWorksheet("جدول " + teacherName, {
