    ...
    <aside id="sidebar" class="fixed md:static md:flex-none inset-y-0 right-0 z-50 w-64 bg-white shadow-lg md:translate-x-0 overflow-y-auto">
        ...
        <nav class="px-4 pb-6 pt-4">
            <ul class="space-y-2">
                <?php if (isAdmin()): ?>
                <li>
                    <a href="dashboard.php" class="flex items-center gap-3 px-4 py-3 text-sm font-medium <?php echo $_ac('dashboard.php'); ?> rounded-custom">
                ...
                <?php endif; ?>
                <?php if (!isTeacher() && (!isUser() || $perms['perm_user_subjects_view'])): ?>
                <li>
                    <a href="subjects.php" class="flex items-center gap-3 px-4 py-3 text-sm font-medium <?php echo $_ac('subjects.php'); ?> rounded-custom">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <?php endif; ?>
                <?php if (!isTeacher() && (!isUser() || $perms['perm_user_teachers_view'])): ?>
                <li>
                    <a href="teachers.php" class="flex items-center gap-3 px-4 py-3 text-sm font-medium <?php echo $_ac('teachers.php'); ?> rounded-custom">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <?php endif; ?>
                <?php if (!isTeacher() && (!isUser() || $perms['perm_user_rooms_view'])): ?>
                <li>
                    <a href="rooms.php" class="flex items-center gap-3 px-4 py-3 text-sm font-medium <?php echo $_ac('rooms.php'); ?> rounded-custom">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <?php if (!isUser()): ?>
                <li>
                    <a href="my_schedule.php" class="flex items-center gap-3 px-4 py-3 text-sm font-medium <?php echo $_ac('my_schedule.php'); ?> rounded-custom">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <?php endif; ?>
                <?php if (!isTeacher() && (!isUser() || $perms['perm_user_view_schedule'])): ?>
                <li>
                    <a href="view_schedule.php" class="flex items-center gap-3 px-4 py-3 text-sm font-medium <?php echo $_ac('view_schedule.php'); ?> rounded-custom">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <?php endif; ?>
                <?php if (!isTeacher() && (!isUser() || $perms['perm_user_exam_schedule'])): ?>
                <li>
                    <a href="exam_schedule.php" class="flex items-center gap-3 px-4 py-3 text-sm font-medium <?php echo $_ac('exam_schedule.php'); ?> rounded-custom">
                ...
                <?php if (isAdmin()): ?>
                <li>
                    <a href="users.php" class="flex items-center gap-3 px-4 py-3 text-sm font-medium <?php echo $_ac('users.php'); ?> rounded-custom">
                ...
                <li>
                    <a href="permissions.php" class="flex items-center gap-3 px-4 py-3 text-sm font-medium <?php echo $_ac('permissions.php'); ?> rounded-custom">
                ...
                <?php endif; ?>
                <li>
                    <a href="account.php" class="flex items-center gap-3 px-4 py-3 text-sm font-medium <?php echo $_ac('account.php'); ?> rounded-custom">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
